    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sender_doctor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='doctor.customdoctor')),
        ...
        migrations.AddField(
            model_name='chatroom',
            name='consultation',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='app.consultation'),
        ),
        migrations.CreateModel(
            name='Notification',
            fields=[
